...
For a string S=s1 s2�sn, n rotations are possible. Let's represent these rotations by r1,r2�rn. Rotating it once will result in string r1=s2s3�sns1, rotating it again will result in string r2=s3s4�sns1s2 and so on. Formally, ith rotation will be equal to ri=si+1�sn-1sns1�si. Note that rn=S.
